...
x = numpy.array( [ 1.3, 2.4, 2.8, 4.9, 7.0] )
ux = numpy.array( [0.5, 0.2, 0.3, 0.2, 0.1] )
y = numpy.array( [4.6, 10.3, 15.0, 24.1, 35.0] )
uy = numpy.array( [0.8, 0.3, 0.7, 1.5, 0.1] )
...
# Test ucurve_fit
P = ucurve_fit( retta, X, Y)

print(P)
print( chi2LS( retta, P, X, Y ) )
plotter( retta, P, X, Y )
...
P = MLS( retta, dretta, X, Y, verbose = False )
